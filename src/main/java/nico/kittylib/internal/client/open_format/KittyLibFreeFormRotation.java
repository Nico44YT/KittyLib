...
public class KittyLibFreeFormRotation {
    private final AffineTransformation affineTransformation;
    private final Vector3f origin;
    private final Vector3f rotationVector;

    public KittyLibFreeFormRotation(float x, float y, float z, Vector3f origin) {
    ...
    public static KittyLibFreeFormRotation deserializeRotation(JsonObject object) {
        if(object.has("rotation")) {
            ...
            return new KittyLibFreeFormRotation(x, y, z, origin);
        }

        return new KittyLibFreeFormRotation(0, 0, 0, new Vector3f());
    }
