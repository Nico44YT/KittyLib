...
public class KittyLibObjDeserializer {
    ...
    public static float[] objToFaceList(Resource resource) {
        try (BufferedReader reader = resource.getReader()) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (line.startsWith("f ")) {
                    try {
                        ...
                        System.out.println("Error thrown while deserialization");
                        e.printStackTrace();
                    }
                }
            }
            ...
            for (int i = 0; i < faces.size(); i++) {
                ...
                vertexData[i * 8 + 7] = texCoord.y();
            }

            return vertexData;
        } catch (Exception e) {
            System.out.println("Error thrown while vertexData assembly");
            e.printStackTrace();
            return NULL_MODEL;
        }
    }
