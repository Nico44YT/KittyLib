...
public class KittyLibDrawContext extends DrawContext {
    public KittyLibDrawContext(MinecraftClient client, VertexConsumerProvider.Immediate vertexConsumers) {
        super(client, vertexConsumers);
    }

    public KittyLibDrawContext(DrawContext drawContext) {
