...
public class KittyLibObjModel {
    ...
    public void render(VertexConsumer vertexConsumer, MatrixStack matrices, int light, int overlay) {
        ...
        this.render(vertexConsumer, entry, light, overlay, new int[]{255, 255, 255, 255}, new boolean[]{false, false, false});
    }

    public void render(VertexConsumer vertexConsumer, MatrixStack.Entry entry, int light, int overlay, int[] rgba, boolean[] mirror) {
        for (KittyLibFace face : this.faces) {
            face.render(vertexConsumer, entry, light, overlay, rgba, mirror);
        }
    }
