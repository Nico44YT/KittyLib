...
public class KittyLibIdentifier extends Identifier {
    protected KittyLibIdentifier(String namespace, String path) {
        super(namespace, path);
    }

    protected KittyLibIdentifier(Identifier id) {
        this(id.getNamespace(), id.getPath());
    }

    public static KittyLibIdentifier of(Identifier id) {
    ...
    public static KittyLibIdentifier tryParse(String namespace, String path) {
        return new KittyLibIdentifier(namespace, path);
    }
    ...
    public static KittyLibIdentifier tryParseOrDefault(String id, String defaultNamespace) {
        ...
        if(parts.length >= 2) return KittyLibIdentifier.tryParse(parts[0], parts[1]);
        return KittyLibIdentifier.tryParse(defaultNamespace, parts[0]);
    }
