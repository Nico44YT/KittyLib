...
/**
 * Taken from <a href="https://github.com/LodestarMC/Lodestone">Lodestone</a>
 * This file is licensed under LGPL-3.0 as it was taken from Lodestone
 */
public abstract class KittyLibEasing {

    public static final HashMap<String, KittyLibEasing> EASINGS = new HashMap<>();
    public final String name;

    public KittyLibEasing(String name) {
        this.name = name;
        EASINGS.put(name, this);
    }

    public static KittyLibEasing valueOf(String name) {
     ...
     */
    public static final KittyLibEasing LINEAR = new KittyLibEasing("linear") {
     ...
     */
    public static final KittyLibEasing QUAD_IN = new KittyLibEasing("quadIn") {
        public float ease(float t, float b, float c, float d) {
            return c * (t /= d) * t + b;
        }
    };
     ...
     */
    public static final KittyLibEasing QUAD_OUT = new KittyLibEasing("quadOut") {
        public float ease(float t, float b, float c, float d) {
            return -c * (t /= d) * (t - 2) + b;
        }
    };
     ...
     */
    public static final KittyLibEasing QUAD_IN_OUT = new KittyLibEasing("quadInOut") {
        public float ease(float t, float b, float c, float d) {
            if ((t /= d / 2) < 1) {
                return c / 2 * t * t + b;
            }
     ...
     */
    public static final KittyLibEasing CUBIC_IN = new KittyLibEasing("cubicIn") {
        public float ease(float t, float b, float c, float d) {
            return c * (t /= d) * t * t + b;
        }
    };
     ...
     */
    public static final KittyLibEasing CUBIC_OUT = new KittyLibEasing("cubicOut") {
        public float ease(float t, float b, float c, float d) {
     ...
     */
    public static final KittyLibEasing CUBIC_IN_OUT = new KittyLibEasing("cubicInOut") {
        public float ease(float t, float b, float c, float d) {
            if ((t /= d / 2) < 1) {
                return c / 2 * t * t * t + b;
            }
     ...
     */
    public static final KittyLibEasing QUARTIC_IN = new KittyLibEasing("quarticIn") {
        public float ease(float t, float b, float c, float d) {
     ...
     */
    public static final KittyLibEasing QUARTIC_OUT = new KittyLibEasing("quarticOut") {
        public float ease(float t, float b, float c, float d) {
     ...
     */
    public static final KittyLibEasing QUARTIC_IN_OUT = new KittyLibEasing("quarticInOut") {
        public float ease(float t, float b, float c, float d) {
            if ((t /= d / 2) < 1) {
     ...
     */
    public static final KittyLibEasing QUINTIC_IN = new KittyLibEasing("quinticIn") {
        public float ease(float t, float b, float c, float d) {
     ...
     */
    public static final KittyLibEasing QUINTIC_OUT = new KittyLibEasing("quinticOut") {
        public float ease(float t, float b, float c, float d) {
     ...
     */
    public static final KittyLibEasing QUINTIC_IN_OUT = new KittyLibEasing("quinticInOut") {
        public float ease(float t, float b, float c, float d) {
            if ((t /= d / 2) < 1) {
     ...
     */
    public static final KittyLibEasing SINE_IN = new KittyLibEasing("sineIn") {
        public float ease(float t, float b, float c, float d) {
     ...
     */
    public static final KittyLibEasing SINE_OUT = new KittyLibEasing("sineOut") {
        public float ease(float t, float b, float c, float d) {
     ...
     */
    public static final KittyLibEasing SINE_IN_OUT = new KittyLibEasing("sineInOut") {
        public float ease(float t, float b, float c, float d) {
     ...
     */
    public static final KittyLibEasing EXPO_IN = new KittyLibEasing("expoIn") {
        public float ease(float t, float b, float c, float d) {
     ...
     */
    public static final KittyLibEasing EXPO_OUT = new KittyLibEasing("expoOut") {
        public float ease(float t, float b, float c, float d) {
     ...
     */
    public static final KittyLibEasing EXPO_IN_OUT = new KittyLibEasing("expoInOut") {
        public float ease(float t, float b, float c, float d) {
            if (t == 0) {
                return b;
            }
     ...
     */
    public static final KittyLibEasing CIRC_IN = new KittyLibEasing("circIn") {
        public float ease(float t, float b, float c, float d) {
     ...
     */
    public static final KittyLibEasing CIRC_OUT = new KittyLibEasing("circOut") {
        public float ease(float t, float b, float c, float d) {
     ...
     */
    public static final KittyLibEasing CIRC_IN_OUT = new KittyLibEasing("circInOut") {
        public float ease(float t, float b, float c, float d) {
            if ((t /= d / 2) < 1) {
     ...
     */
    public static abstract class Elastic extends KittyLibEasing {
     ...
     */
    public static abstract class Back extends KittyLibEasing {
        /**
     ...
     * Bounce easing in.
     */
    public static final KittyLibEasing BOUNCE_IN = new KittyLibEasing("bounceIn") {
        public float ease(float t, float b, float c, float d) {
            return c - KittyLibEasing.BOUNCE_OUT.ease(d - t, 0, c, d) + b;
        }
    };
     ...
     * Bounce easing out.
     */
    public static final KittyLibEasing BOUNCE_OUT = new KittyLibEasing("bounceOut") {
        public float ease(float t, float b, float c, float d) {
            if ((t /= d) < (1 / 2.75f)) {
     ...
     */
    public static final KittyLibEasing BOUNCE_IN_OUT = new KittyLibEasing("bounceInOut") {
        public float ease(float t, float b, float c, float d) {
            if (t < d / 2) {
                return KittyLibEasing.BOUNCE_IN.ease(t * 2, 0, c, d) * .5f + b;
            }
            return KittyLibEasing.BOUNCE_OUT.ease(t * 2 - d, 0, c, d) * .5f + c * .5f + b;
        }
    };
}