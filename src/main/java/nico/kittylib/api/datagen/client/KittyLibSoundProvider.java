...
public abstract class KittyLibSoundProvider implements DataProvider {

    protected final DataOutput.PathResolver soundFilePathResolver;
    protected final JsonObject rootObject;
    protected final String id;

    public KittyLibSoundProvider(String id, FabricDataOutput output) {
        this.id = id;
    ...
    public void registerSound(@NotNull SoundEvent soundEvent, @Nullable String subtitle, @Nullable Boolean replace, @NotNull KittyLibSoundData... instances) {
        this.registerSound(soundEvent.getId().getPath(), subtitle, replace, instances);
    }

    public void registerSound(@NotNull String soundKey, @Nullable String subtitle, @Nullable Boolean replace, @NotNull KittyLibSoundData.Builder... instances) {
        this.registerSound(soundKey, subtitle, replace, Arrays.stream(instances).map(KittyLibSoundData.Builder::build).toArray(KittyLibSoundData[]::new));
    }
    ...
    public static void registerSound(JsonObject rootObject, @NotNull String soundKey, @Nullable String subtitle, @Nullable Boolean replace, @NotNull KittyLibSoundData[] instances) {
        ...
        for (@NotNull KittyLibSoundProvider.KittyLibSoundData instance : instances) {
    ...
    public CompletableFuture<?> run(DataWriter writer) {
        return DataProvider.writeToPath(writer, rootObject, soundFilePathResolver.resolve(Identifier.tryParse(id, "sounds"), "json"));
    }
    ...
    public record KittyLibSoundData(String name, Float volume, Float pitch, Integer weight, Boolean stream, Integer attenuationDistance, Boolean preload, Type type) {
        ...
        public static KittyLibSoundData create(String name) {
            return KittyLibSoundData.create(name, null, null, null, null, null, null, null);
        }

        public static KittyLibSoundData create(String name, Float volume, Float pitch) {
            return KittyLibSoundData.create(name, volume, pitch, null, null, null, null, null);

        }

        public static KittyLibSoundData create(String name, Float volume, Float pitch, Integer weight) {
            return KittyLibSoundData.create(name, volume, pitch, weight, null, null, null, null);

        }

        public static KittyLibSoundData create(String name, Float volume, Float pitch, Integer weight, Boolean stream) {
            return KittyLibSoundData.create(name, volume, pitch, weight, stream, null, null, null);

        }

        public static KittyLibSoundData create(String name, Float volume, Float pitch, Integer weight, Boolean stream, Integer attenuationDistance, Boolean preload, Type type) {
            return new KittyLibSoundData(name, volume, pitch, weight, stream, attenuationDistance, preload, type);
        }
        ...
        public static class Builder {
            ...
            public KittyLibSoundData build() {
                return KittyLibSoundData.create(name, volume, pitch, weight, stream, attenuationDistance, preload, type);
            }
        }
    }
}