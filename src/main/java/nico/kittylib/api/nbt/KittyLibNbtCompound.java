...
public class KittyLibNbtCompound extends NbtCompound {
    ...
    public Identifier getIdentifier(String key) {
        ...
        return Identifier.tryParse(idNbt.getString("namespace"), idNbt.getString("path"));
    }
    ...
    public Identifier[] getIdentifierArray(String key) {
        ...
        for(int i = 0; i<length; i++) {
            ...
            returnable[i] = Identifier.tryParse(idNbt.getString("namespace"), idNbt.getString("path"));
        }
